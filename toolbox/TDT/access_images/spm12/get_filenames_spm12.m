...
% 
% Function to get file names using SPM12. Supports both wildcard and
...
%
% Example calls:
%       fnames = get_filenames_spm12('/home/resultsdir','*.nii') 
%           will select all nifti files in the provided folder
%
%       fnames = get_filenames_spm12('/home/resultsdir/*.nii')
%           same result as above
%
%       fnames = get_filenames_spm12('/home/resultsdir','REGEXP:^rf.*\.nii$')
