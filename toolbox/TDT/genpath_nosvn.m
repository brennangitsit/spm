function p = genpath_nosvn(d)
%GENPATH Generate recursive toolbox path (ignoring .svn entries)
...
for i=1:length(dirs)
    ...
    if    ~strcmp( dirname,'.')         & ...
        ...
        p = [p genpath_nosvn(fullfile(d,dirname))]; % recursive calling of this function % corrected by Kai Goergen 
    end
end
